 ...
 */
class SignesVariables extends ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_signe', 'required'),
			array('name', 'required'),
			array('value', 'required'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, id_signe, name, value', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_signe',$this->id_signe);
