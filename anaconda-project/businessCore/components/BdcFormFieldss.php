 ...
 * @package BDC
 */
class BdcFormFieldss extends CForm
{
	/**
	...
	public function __construct( $Model )
	{
		...
		//$this->model->birthday = '05/15/2000'; 
		//\Yii::app()->params['formatDate'] = 'm/d/Y';
	...
	public function render()
	{
		...
		foreach( $this->bdcFields as $name => $type )
		{
            ...
            if( strcmp ( $label , "firstName" ) == 0  || strcmp ( $label , "lastName" ) == 0 || strcmp ( $label , "birthday" ) == 0 ){ 			
	   ...
	   foreach( $this->bdcFields as $name => $type )
		{
			...
			if( ($Elt->name == "civility" || $Elt->name == "firstName" || $Elt->name == "lastName" || $Elt->name == "birthday") ){
