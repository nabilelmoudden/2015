    ...
    if($compte=="acq"){
        if (isset(\Yii::app()->params[MKT_EMV_ACQ]['wdsl']) ) {
              ...
              try {
                  ...
                  $err .= 'impossible de se connecter pour faire acquerir des compagnes depuis serveur: <b>)</b><br />';
                  $msg .= '<div style="color: red"><u>' . $porteur . '(ACQ) </u> : ' . $err . '</div><br /><br />';
    ...
    if($compte=="acq"){
        if (isset(\Yii::app()->params['CMD_EMV_ACQ']['wdsl']) ) {
              ...
              try {
                  ...
                  $err .= 'impossible de se connecter pour faire acquerir les ids messages depuis serveur: <b>)</b><br />';
                  $msg .= '<div style="color: red"><u>' . $porteur . '(ACQ) </u> : ' . $err . '</div><br /><br />';
