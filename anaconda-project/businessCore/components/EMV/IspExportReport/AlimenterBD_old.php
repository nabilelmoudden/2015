...
//$client =  new SoapClient(Yii::app()->params['isp_acces_api'][$porteur]['ispsiteApi']['url']);
...
/*  $client =  new SoapClient(Yii::app()->params['isp_acces_api'][$porteur]['ispsiteApiexport']['url']);
   
   $xml_array = ['token'=>$token,'page'=>$page,'perPage'=>'100','campaignType'=>'TRIGGER','beginDate'=>'2016-03-03T00:00:01+01:00','endDate'=>'2016-03-04T00:00:00+01:00'];
...
function getmesagename($token,$messageid,$porteur,$compte){
          ...
          /*  $client = new SoapClient(Yii::app()->params['isp_acces_api'][$porteur]['ispsiteApi']['url']);
          $xml_array = ['token'=>$token,'id'=>$messageid];
          $response =  (array)$client->getMessage($xml_array);
          $messaginfo = (array)$response['return'];
          $messagename=(string) $messaginfo['name'];
