 ...
 */
class AngesVariables extends \AngesVariables
{
	...
	public function relations()
	{
		...
		return array(
			'Anges' => array(self::BELONGS_TO, '\Business\Anges', 'id_ange'),
		);
	}
...
static public function loadByIdAnge( $idange )
	{

		
		return self::model()->findAllByAttributes(array( 'id_ange' => $idange));
	}
}
