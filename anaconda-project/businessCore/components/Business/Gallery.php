...
//		if($fid_type == 'oui') $url .= ($fid_product == 'product_1') ? '&sp=1' : '&sp=2';
		...
		//site : Que pour V2
		if(($fid_type == 'oui') && ($porteur == 'es_laetizia' || $porteur == 'en_alisha' || $porteur == 'en_aasha' || $porteur =='en_aasha_acq' || $porteur =='en_aasha_acq' || $porteur =='pt_rmay' || $porteur =='br_rmay' || $porteur =='es_rmay' || $porteur =='mx_rmay' || $porteur =='cl_rmay' || $porteur =='ar_rmay' || $porteur =='in_laetizia' || $porteur =='ie_laetizia' || $porteur =='pt_laetizia' || $porteur =='br_laetizia' || $porteur =='br_rinalda' || $porteur =='pt_rinalda')){
	...
	public function getUrlFAQ($porteur, $fid_name, $fid_product, $fid_type){
		...
		$siteTxt =($porteur == 'no_ml') ? 'SiteInst' : $siteTxt;
		...
		$url  =($porteur =='no_ml') ?$site.'/voyances/index.php/SiteInst/FAQ?' :$site.'/'.$GLOBALS['porteurUrl'][$porteur]['folder'].'/'.$siteTxt.'/index.php?'.$page.'='.$faq.'.php&';
		...
		$url .= ($fid_type == 'oui') ? $fid_name.'_'.(($fid_product == 'product_1') ?  '1' : '2' ) : $porteur.'_'.$fid_name.(($fid_product == 'product_1') ?  '' : 'ct' );
		return $url;
	}
}
