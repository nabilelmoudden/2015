...
class AnacondaController extends AdminController
{
    ...
    public function init()
    {
        ...
        Yii::app()->user->loginUrl = array('/anaconda/login');
        // Default page title :
    ...
    public function actionIndex()
    {
        ...
        $this->render('//anaconda/base');
    }

    public function actionSettings()
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/settings');
    }
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/organiserFid');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/lots');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/ajouterFid');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/updatesettings');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/ajouterEnchainement');
    }

    public function actionDeplacer()
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/deplacer');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/replace');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/webforms');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/segments');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/permuter');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/confirmation');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/subdivision');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/waitingsubdivision');
    ...
    {
        $this->layout = "";
        $this->renderPartial('//anaconda/infobulle');
