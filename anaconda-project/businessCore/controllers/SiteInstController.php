...
/**
 * Description of SiteInstController
 *
...
class SiteInstController extends Controller
{
	...
	public function actionIndex(){
		...
		$viewDir = $this->portViewDir.'/'.$porteur.'/siteInst/';
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/index'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	...
	public function actionTestimonial(){
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/testimonial'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	...
	public function actionTerms(){
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/terms'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	...
	public function actionFAQ(){
		...
		$viewDir = $this->portViewDir.'/'.$porteur.'/siteInst/';
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/faq'.$site, 
			array(
				'porteur' => $porteur, 'messconf' => Yii::t( 'siteInst', $messconf ), 'm' => $m, 't' => $t, 'ref' => $ref, 'emv8' => $emv8,
	...
	public function actionStore(){
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/store'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	...
	public function actionForm(){
		...
		if(Yii::app()->request->getParam( 'form_validate' ) !== NULL){
			...
			if($User){
				...
				if($double){
					...
					$Leadaff->creationDate = date("Y-m-d H:i:s");
					$Leadaff->isDouble = 1;
					$Leadaff->save();
					...
					$LeadaffV1->creationDate = date("Y-m-d H:i:s");
					...
					if($Product){
						...
						$Invoice->creationDate = date("Y-m-d H:i:s");
						$Invoice->invoiceStatus = 1;
						$Invoice->campaign = 'stc';
						$Invoice->priceStep = 1;
						$Invoice->refBatchSelling = 1;
				...
				$UserV1->CreationDate = date("Y-m-d H:i:s");
			...
			$this->redirect(array('siteInst/thanks', 'emv8' => $emv8));
		}
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/form'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	...
	public function actionPrivacy(){
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/privacy'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	...
	public function actionConsultation(){
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/consultation'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	...
	public function actionThanks(){
		...
		// Rendu de la page :
		$this->render( '//'.$porteur.'/siteInst/thanks'.$site, array('porteur' => $porteur, 'viewDir' => $viewDir, 'email' => $email, 'ref' => $ref, 'emv8' => $emv8, 'baseDir' => \Yii::app()->baseUrl) );
	}
	
		/**
	 * Retourne la valeur d'un paramÃƒÆ’Ã‚Â©tre
	 * @return string
	 */
